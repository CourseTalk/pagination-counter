...
describe('pagination', function () {
    ...
    describe('getPages with custom options', function () {
        ...
        it('get pages: page 5 max page: 10 options: {edges_limit: 2, center_limit: 4}', function () {
            var result = pagination.getPages(5, 10, {edges_limit: 2, center_limit: 4});
        ...
        it('get pages: page 2 max page: 10 options: {edges_limit: 2, center_limit: 4}', function () {
            var result = pagination.getPages(2, 10, {edges_limit: 2, center_limit: 4});
        ...
        it('get pages: page 2 max page: 10 options: {edges_limit: 2, center_limit: 4. hide_last_page: true}', function () {
            var result = pagination.getPages(2, 10, {edges_limit: 2, center_limit: 4, hide_last_page: true});
